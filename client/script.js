...
// CODE HERE
function mouseOverHello(){
    sayHelloButton.classList.add("helloButtonBlack")
    if (sayHelloButton.classList.contains("helloButtonWhite")){
        sayHelloButton.classList.remove("helloButtonWhite")
    }
}

sayHelloButton.addEventListener("mouseover", mouseOverHello)
// PROBLEM 3
/*
...
// CODE HERE
function mouseOffHello(){
    sayHelloButton.classList.remove("helloButtonBlack")
    sayHelloButton.classList.add("helloButtonWhite")
}

sayHelloButton.addEventListener("mouseout", mouseOffHello)
...
const repeatMyParam = () => {
    //YOUR CODE HERE
    axios.get("http://localhost:3000/repeat/testing")
...
function randomQuery(){
    axios.get("http://localhost:3000/query-test?banana")
    .then(res => console.log(res.data))
}
let queryButton = document.querySelector("#query-button")

queryButton.addEventListener("click", randomQuery)
...
function createFood(event){
    ...
    .then(function(res){
        ...
        paragraph.textContent = res.data
        document.body.append(paragraph)
    })
}

let submitFood = document.querySelector(".submitFood")
submitFood.addEventListener("click", createFood)
